...
class BaseDataset(Dataset):
    ...
    def add_attrib(self, key, func, func_args):
        ...
        Args:
            ...
            func:
                function to process a data sample and create an attribute 
            func_args:
...
class PairedDataset(Dataset):
    ...
    When 'same=True',
        ...
        e.g. [[ds1_3, ds1_2], [ds3_1, ds3_2], [ds2_1, ds2_2], ...], ds1_3 means third sample in the first dataset
    When 'same=False',
    ...
    def __init__(self, datasets, n_elements, max_iters, same=True,
        ...
        super().__init__()
        self.datasets = datasets # a list of Dataset
        self.n_datasets = len(self.datasets) # total number of Datasets
        self.n_data = [len(dataset) for dataset in self.datasets] # a list of number of datas in each Dataset
        self.n_elements = n_elements # number of elements in each tuple
        self.max_iters = max_iters # number of tuples to be sampled
        self.pair_based_transforms = pair_based_transforms # data augmentation
        if same:
